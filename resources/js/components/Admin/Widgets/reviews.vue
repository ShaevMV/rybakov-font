    ...
    <div>
        <div class="panel panel-default" v-for="(item,index) in params">
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-10">Отзыв {{index+1}}</div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="ФИО" v-model="item.params.name"/>
                            </div>

                            <div class="form-group">
                                <label class="control-label">дата</label>
                                <input class="form-control" type="date" placeholder="дата" v-model="item.params.data"/>
                            </div>
                            <div class="form-group">
