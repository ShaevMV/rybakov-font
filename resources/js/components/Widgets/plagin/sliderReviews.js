...
(function ($) {
    ...
    $.fn.waterwheelCarousel.defaults = {
        ...
        separation: 332, // distance between items in carousel
        ...
        opacityMultiplier: 0.65, // determines how drastically the opacity of each item changes
...
//             $(".dots span[data-dots-item="+$item.data("item")+"]").addClass("active");
//         }
//     });
//
//
